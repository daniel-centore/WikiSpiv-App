...
// Adapted from https://github.com/facebook/react-native/blob/a1ac2518a364ebcd3cc024a22229cadc1791e1c4/Libraries/Utilities/MatrixMath.js#L19
...
const MatrixMath = {
  ...
  createOrthographic: function(left: any, right: any, bottom: any, top: any, near: any, far: any) {
  ...
  createFrustum: function(left: any, right: any, bottom: any, top: any, near: any, far: any) {
   ...
   */
  createPerspective: function(fovInRadians: any, aspect: any, near: any, far: any) {
  ...
  createTranslate2d: function(x: any, y: any) {
    const mat = MatrixMath.createIdentityMatrix();
    MatrixMath.reuseTranslate2dCommand(mat, x, y);
    return mat;
  },

  reuseTranslate2dCommand: function(matrixCommand: any, x: any, y: any) {
    matrixCommand[12] = x;
    matrixCommand[13] = y;
  },

  reuseTranslate3dCommand: function(matrixCommand: any, x: any, y: any, z: any) {
    matrixCommand[12] = x;
    matrixCommand[13] = y;
    matrixCommand[14] = z;
  },

  createScale: function(factor: any) {
    const mat = MatrixMath.createIdentityMatrix();
    MatrixMath.reuseScaleCommand(mat, factor);
    return mat;
  },

  reuseScaleCommand: function(matrixCommand: any, factor: any) {
    matrixCommand[0] = factor;
    matrixCommand[5] = factor;
  },

  reuseScale3dCommand: function(matrixCommand: any, x: any, y: any, z: any) {
    matrixCommand[0] = x;
    matrixCommand[5] = y;
    matrixCommand[10] = z;
  },

  reusePerspectiveCommand: function(matrixCommand: any, p: any) {
    matrixCommand[11] = -1 / p;
  },

  reuseScaleXCommand(matrixCommand: any, factor: any) {
    matrixCommand[0] = factor;
  },

  reuseScaleYCommand(matrixCommand: any, factor: any) {
    matrixCommand[5] = factor;
  },

  reuseScaleZCommand(matrixCommand: any, factor: any) {
    matrixCommand[10] = factor;
  },

  reuseRotateXCommand: function(matrixCommand: any, radians: any) {
  ...
  reuseRotateYCommand: function(matrixCommand: any, amount: any) {
  ...
  reuseRotateZCommand: function(matrixCommand: any, radians: any) {
  ...
  createRotateZ: function(radians: any) {
    const mat = MatrixMath.createIdentityMatrix();
    MatrixMath.reuseRotateZCommand(mat, radians);
    return mat;
  },

  reuseSkewXCommand: function(matrixCommand: any, radians: any) {
    matrixCommand[4] = Math.tan(radians);
  },

  reuseSkewYCommand: function(matrixCommand: any, radians: any) {
    matrixCommand[1] = Math.tan(radians);
  },

  multiplyInto: function(out: any, a: any, b: any) {
    const a00 = a[0],
      a01 = a[1],
      a02 = a[2],
      a03 = a[3],
   ...
   * roll  === bank               === x-axis
   */
  quaternionToDegreesXYZ(q: Array<number>, matrix: any, row: any): Array<number> {
    const [qx, qy, qz, qw] = q;
    const qw2 = qw * qw;
    const qx2 = qx * qx;
    const qy2 = qy * qy;
